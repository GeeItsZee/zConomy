...
public class zConomyVault implements Economy
{
  private final zConomyPlugin plugin;
  private final Settings settings;

  public zConomyVault(zConomyPlugin plugin, Settings settings)
  {
    this.plugin = plugin;
  ...
  {
    BankAccount account = plugin.getzConomyDatabase().getBankAccount(playerName);
    return account != null;
  }
  ...
  public EconomyResponse withdrawPlayer(String playerName, double amount)
  {
    ...
    if (account == null)
    {
      return new EconomyResponse(0, 0, ResponseType.FAILURE, "No account found");
    }
    ...
    zConomyDatabase.addToBankAccountBalance(playerName, -amount);
  ...
  public EconomyResponse createBank(String name, String player)
  {
    ...
    try
    {
      zConomyDatabase.createBankAccount(name);
      return new EconomyResponse(0, 0, ResponseType.SUCCESS, null);
    }
    catch (ExistingBankAccountException ex)
    {
      return new EconomyResponse(0, 0, ResponseType.FAILURE, "Account already exists");
    }
  }
  ...
  {
    zConomyDatabase zConomyDatabase = plugin.getzConomyDatabase();
    boolean found = zConomyDatabase.removeBankAccount(name);
  ...
  {
    BankAccount account = plugin.getzConomyDatabase().getBankAccount(name);
  ...
  public EconomyResponse isBankOwner(String name, String playerName)
  {
    ...
    {
      return new EconomyResponse(0, 0, ResponseType.FAILURE, "Not account owner");
    }
  }
