 ...
 */
package com.gmail.tracebachi.zConomy.Exceptions;

/**
 * Created by Trace Bachi (tracebachi@gmail.com, BigBossZee) on 3/7/16.
 */
public class ExistingBankAccountException extends RuntimeException
{
    public ExistingBankAccountException(Throwable cause)
    {
        super(cause);
    }
}
