...
public class Give
{
  private static final String COMMAND_PERM = "zConomy.Give";

  private final zConomyPlugin plugin;
  private final Settings settings;

  public Give(zConomyPlugin plugin, Settings settings)
  {
    this.plugin = plugin;
  ...
  public void handle(CommandSender sender, String name, String amountString)
  {
    ...
    {
      sender.sendMessage(settings.format("AccountGive", settings.formatAmount(amount), name));
    }
    else
    {
