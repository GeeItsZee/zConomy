...
public class Remove
{
    ...
    {
        if(!sender.hasPermission("zConomy.Remove"))
        {
            sender.sendMessage(Settings.format("NoPermission", "zConomy.Remove"));
            return;
        }
        ...
        boolean found = database.removeAccount(name);
